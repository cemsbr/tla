...
public class LogProcessorTest {
	...
	public void testLogTomcatMatching() {
		assertTrue(entries
				.matchesTomcatPattern("198.55.32.149 - - [16/Oct/2012:00:00:08 -0700] \"POST /registry/endpoint HTTP/1.1\" 200 590 1"));
		assertTrue(entries
				.matchesTomcatPattern("198.55.32.149 - - [10/Oct/2012:05:26:28 -0700] \"POST /supermarket3/orchestration HTTP/1.1\" 200 2264 4"));
		assertFalse(entries
				.matchesTomcatPattern("178.237.128.23 - tomcat [10/Oct/2012:04:12:12 -0700] \"HEAD /manager/html HTTP/1.0\" 200 - 26"));
		assertFalse(entries
				.matchesTomcatPattern("198.55.32.149 - - [10/Oct/2012:05:26:26 -0700] \"GET /supermarket3/orchestration?wsdl HTTP/1.1\" 200 2171 41"));
		assertFalse(entries
				.matchesTomcatPattern("178.237.128.23 - - [10/Oct/2012:04:12:12 -0700] \"HEAD /manager/html HTTP/1.0\" 401 - 1"));
	}
